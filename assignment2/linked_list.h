...
typedef struct list_entry list_entry_t; /// Meta: struct definition goes in C file
typedef struct list ioopm_list_t; /// Meta: struct definition goes in C file
typedef struct iterator ioopm_list_iterator_t; /// Meta: struct definition goes in C file

typedef bool(*ioopm_char_predicate)(int idx, elem_t val, void* extra);
typedef void(*ioopm_apply_char_function)(int idx, elem_t* val, void* extra);
...
/// @param index the position in the list
/// @param value the value to be appended
/// @param valptr a pointer to where the removed element will be stored.
/// @return IOOPM_RESULT code indicating success or error
...
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @param valptr a pointer to where the element should be stored
/// @return IOOPM_RESULT code indicating success or error
